...
# Q1: Initial products list updated with 3 new items (IDs 5, 6, 7)
products = [
    ...
    {"id": 3, "name": "Water Bottle", "price": 499, "category": "Home", "in_stock": False},
...
# Q5: Case-Insensitive Search Endpoint
...
def get_deals():
    if not products:
        return {"error": "Product list is empty"}
